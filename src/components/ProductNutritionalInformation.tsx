        ...
        <div className="nutrition" id="nutrition">
            ...
            <div id="grafico" data-kj="3768.12" data-cal="900" data-g="100" data-h="0" data-p="0" data-s="0" data-f="" className="svggraph">
                ...
                <svg width="100%" height="100%">
                    <path id="arc1" fill="none" stroke="#F6F6F6" stroke-width="45" d="M 67.9060301978499 10.036550378854258 A 60 60 0 1 0 70 10"></path>
                    <path id="arc2" fill="none" stroke="#CBF3D7" stroke-width="45" d="M 129.98684100849073 68.74345480699854 A 60 60 0 0 0 116.23079456654733 31.75456061507858"></path><path id="arc3" fill="none" stroke="#FCE4C0" stroke-width="45" d="M 116.23079456654733 31.75456061507858 A 60 60 0 0 0 82.47470144906552 11.311143955971652"></path>
                    <path id="arc4" fill="none" stroke="#F1C3C3" stroke-width="45" d="M 82.47470144906552 11.311143955971652 A 60 60 0 1 0 70 130"></path><path id="arc5" fill="none" stroke="#D9ECFF" stroke-width="45" d="M 82.47470144906552 11.311143955971652 A 60 60 0 1 0 70 130"></path>
                    <path id="arc6" fill="none" stroke="#0051A1" stroke-width="45" d="M 82.47470144906552 11.311143955971652 A 60 60 0 1 0 70 130"></path><animate xlinkHref="#arc1" attributeName="stroke-width" from="0" to="45" dur="1s" begin="0s" fill="freeze" />
